    ...
    public static class TouchDeviceProfiles
    {
        ...
        public static TouchDeviceProfile ResolveForDesktopCdp(string? brand, string? model)
        {
            ...
            return Clone(native,
                ...
                samplingAutocorrelation: Math.Clamp((native.SamplingAutocorrelation + desktop.SamplingAutocorrelation) * 0.5, 0.2, 0.9),
        ...
        private static TouchDeviceProfile Clone(
            ...
            double? samplingAutocorrelation = null,
            ...
            double? inputLatencyMs = null)
        {
            return new TouchDeviceProfile
            {
                ...
                SamplingAutocorrelation = samplingAutocorrelation ?? source.SamplingAutocorrelation,
