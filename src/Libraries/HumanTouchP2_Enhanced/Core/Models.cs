...
namespace PlaywrightHumanInput
{
    ...
    public sealed class HumanSwipeTrace
    {
        ...
        public double PlannedEndX { get; init; }
        public double PlannedEndY { get; init; }
    ...
    public sealed class GesturePlan
    {
        ...
        public double CurvePeakRatio { get; init; } = 0.5;
        public double CurveSecondHarmonic { get; init; }

        // 速度轮廓参数。MotionPeakRatio 决定主速度峰在手势中的相对位置。
        public double MotionPeakRatio { get; init; } = 0.5;
        public bool HasSecondarySubmovement { get; init; }
        public double SecondarySubmovementStrength { get; init; }
        public double SecondarySubmovementCenter { get; init; }
        public double SecondarySubmovementWidth { get; init; }
    ...
    public sealed class HumanTouchRequest
    {
        ...
        public bool EnableSubmovements { get; set; } = true;
        public double? SubmovementChance { get; set; }
